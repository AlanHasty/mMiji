//
//  CSCDevicesViewController.swift
//  mMiji
//
...
class CSCDevicesViewController: UITableViewController {
...
//        let cell = tableView.dequeueReusableCellWithIdentifier("CSCDeviceCell", forIndexPath: indexPath)
//
//        let csc = cscDevices[indexPath.row] as CSCDevice
//        cell.textLabel?.text = csc.name
//        cell.detailTextLabel?.text = csc.macAddress
